        ...
        <div class="card-body">
            ...
            <form method="{{$method}}" action="{{$action}}" enctype="{{$enctype}}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('first_name') is-invalid @enderror" name="first_name" id="first_name"  placeholder="First Name" value="{{(!empty($data->first_name) && isset($data->first_name)) ? $data->first_name : old('first_name')}}" disabled>
                    @error('first_name')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('last_name') is-invalid @enderror" name="last_name" id="last_name"  placeholder="Last Name" value="{{(!empty($data->last_name) && isset($data->last_name)) ? $data->last_name : old('last_name')}}" disabled>
                    @error('last_name')
                    <strong class="text-danger">{{ $message }}</strong>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('phone') is-invalid @enderror" name="phone" id="phone" placeholder="Phone" value="{{(!empty($data->phone) && isset($data->phone)) ? $data->phone : old('phone')}}" disabled>
                    @error('phone')
                    <strong class="text-danger">{{ $message }}</strong>
                    @enderror
                </div>
                <div class="mb-3">
                    ...
                    <select class="select2-options-company-id form-control @error('company_id') is-invalid @enderror" name="company_id" disabled></select>
                    @error('company_id')
                    <strong class="text-danger">{{ $message }}</strong>
                    @enderror
                </div>
